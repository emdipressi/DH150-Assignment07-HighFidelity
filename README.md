...
### Color Contrast 
I used the “Contrast” plugin on Figma (instead of Stark) to check the color contrast on an AA level. It shows some things as failing, but when clicking on it individually they pass. I checked this for all items that were marked failed and made sure they all passed. 
...
This was quite a long process but I enjoyed it. Working with Figma went really well. I found that it was very user friendly and overall was an easy website to design with.  I did not expect to learn how to use Figma so fast. Getting feedback from a small group of classmates was a good thing, since they are knowledgeable in this field as well. They had objective opinions and thoughts which were helpful. Going forward, I think it could be interesting to try out more color on the website. Other prototypes I looked at had color blocking, which I liked. I would also liked to have personally designed some of the other things on the website: the detailed hourly weather graph would have been nice to change and make it easier to use, but wouldn’t know how to design that in Figma and I also did not have enough time to remake it as there were other parts of the website that were more important for me to design. Making more interactions from different spots on the website could be something to try in the future, I think one peer user thought “Forecast” was where current location weather was found, so maybe making current location weather available from different spots on the website could be something I would change. 
